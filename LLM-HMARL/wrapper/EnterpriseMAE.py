...
class EnterpriseMAE(BlueEnterpriseWrapper, MultiAgentEnv):
    ...
    def step(
        ...
        """
        obs, rew, rew_org, terminated, truncated, info = super(BlueEnterpriseWrapper, self).step(
            actions=action_dict, skill = skill, messages=messages
        )
        terminated["__all__"] = False
        truncated["__all__"] = self.env.environment_controller.determine_done()
        return obs, rew, rew_org, terminated, truncated, info
